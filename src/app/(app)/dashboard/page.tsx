...
import { IconCheck, IconClock, IconFlame, IconTrophy } from '@tabler/icons-react';
...
export const metadata: Metadata = {
  ...
  description:
    'Track your focus hours, streaks, task completions, and peer collaboration in one place.',
};
